...
int main(int argc, char const *argv[])
{
	...
	string basepath = "C:\\Users\\Harshavardhan\\IR-term-project\\paper-1\\Verified-Summarization-master_TreeLSTM\\CTP\\";
	string destpath = "C:\\Users\\Harshavardhan\\IR-term-project\\paper-1\\Verified-Summarization-master_TreeLSTM\\CTP\\output_"+to_string(K)+"_"+to_string(T)+"_"+to_string(numIter)+"/";
